...
const Login = () => {
  ...
  return (
    <div className="min-h-screen bg-slate-50 flex items-center justify-center p-4">
      ...
      <button 
        onClick={() => navigate('/')}
        className="absolute top-8 left-8 text-slate-500 hover:text-primary flex items-center gap-2 transition-colors"
      >
      ...
      <div className="max-w-md w-full bg-white rounded-2xl shadow-2xl overflow-hidden border border-slate-100">
        <div className="p-8 md:p-12">
          <div className="text-center mb-10">
            ...
            <p className="text-slate-500 mt-2 text-sm uppercase tracking-widest">Portal de Seguridad Jurídica</p>
          </div>
          ...
          <form className="space-y-6">
            ...
            <div className="bg-slate-50 p-4 rounded-xl border border-dashed border-slate-300">
              ...
              <div className="flex items-center gap-4">
                ...
                <input 
                  ...
                  className="flex-1 px-3 py-2 text-sm rounded border border-slate-200 outline-none focus:border-primary"
                />
              </div>
            </div>
            ...
            <button 
              type="submit" 
              className="w-full bg-slate-900 hover:bg-primary text-white font-bold py-4 rounded-lg transition-all transform hover:-translate-y-1 shadow-lg active:scale-95"
            >
              INGRESAR AL SISTEMA
            </button>
          </form>
          ...
          <div className="mt-8 text-center">
            <a href="#" className="text-xs text-slate-400 hover:text-primary transition-colors underline underline-offset-4">
